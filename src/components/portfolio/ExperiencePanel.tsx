...
const EXPERIENCE = [
  {
    ...
    stack: ["Node.js", "TypeScript", "MongoDB", "Redis", "Webhooks", "React Native"],
  },
  {
    ...
    sfx: "BREAK!",
    points: [
      "Designed and shipped Quick Basket — a farmer-to-consumer marketplace (Node.js, Express.js, MongoDB, React Native) launched on Android and iOS, eliminating supply-chain middlemen.",
      "Architected scalable REST APIs, data models, and schemas for end-to-end order management.",
      "Owned the feature lifecycle from client requirements through design, build, and mobile deployment.",
    ],
    stack: ["Node.js", "Express.js", "MongoDB", "React Native", "REST APIs"],
  },
  {
    ...
    sfx: "POLISH!",
    points: [
      "Built a fully responsive React.js landing page integrated with backend REST APIs.",
      "Raised the Lighthouse score from 64 to 91/100 via code splitting and asset optimization.",
